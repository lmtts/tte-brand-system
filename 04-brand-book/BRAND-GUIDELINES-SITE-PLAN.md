...
- ⬜ **Fases 6–10 — Seções restantes:** para cada uma, Lucas manda o frame **desktop** ou autoriza proposta direta; eu implemento (fidelidade + motion HUD + responsivo mobile) com comparação lado a lado ou 1 screenshot de verificação. Agrupar as repetitivas.
